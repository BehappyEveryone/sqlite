...
import com.techlabs.fortune.SQLiteContract.MemoEntry

private const val SQL_CREATE_ENTRIES =
    "CREATE TABLE ${MemoEntry.TABLE_NAME} (" +
            "${BaseColumns._ID} INTEGER PRIMARY KEY," +
            "${MemoEntry.COLUMN_NAME_TITLE} TEXT," +
            "${MemoEntry.COLUMN_NAME_CONTENT} TEXT)"

private const val SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS ${MemoEntry.TABLE_NAME}"
